<div id="barcode-edit-container" class="container p-4">
        ...
        <label class="block text-sm">
            ...
            <div class="mt-1 space-y-2 md:space-y-0 md:flex md:gap-2">
                ...
                <input type="text" wire:model.defer="barcode" id="barcodeInput"
                    ...
                    class="<?php echo e($inputBase); ?> <?php echo e(inputClass($errors->has('barcode'))); ?>">
...
</div><?php /**PATH /Users/jaizyikhwan/Documents/coding/laravel/soni-elektronik/resources/views/livewire/items/edit.blade.php ENDPATH**/ ?>